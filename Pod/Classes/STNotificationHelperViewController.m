...
- (id)initWithNotification:(STNotificationHelperObject*)notification
{
    ...
    if (self) {
        ...
        self.numberOneDescriptionLabel.text = STNotificationLocalizedString(@"notification.open");
        ...
        self.numberTwoDescriptionLabel.text = STNotificationLocalizedString(@"notification.notificationTap");
        ...
        self.numberFourDescriptionLabel.text = STNotificationLocalizedString(@"notification.activate");
        ...
        self.numberFourDescriptionLabelInDescriptionView.text = STNotificationLocalizedString(@"notification.lockScreen");
        ...
        _numberFourSwitchView = STUISwitchView.new;
        ...
        self.numberFiveDescriptionLabel.text = STNotificationLocalizedString(@"notification.chooseBanner");
        ...
        self.noneLabel.text = STNotificationLocalizedString(@"notification.none");
        ...
        self.bannerLabel.text = STNotificationLocalizedString(@"notification.banner");
        ...
        self.hinweisLabel.text = STNotificationLocalizedString(@"notification.alert");
